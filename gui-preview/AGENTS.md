...
- Use a minimalist, flat visual language for Bypass VPN: near-black background, cyan accent, restrained typography, thin dividers, no gradients, and no decorative cards.
- Keep Share and Connect as the two primary modes and show connection details in a plain, highly scannable list.
